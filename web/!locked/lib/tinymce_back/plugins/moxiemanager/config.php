...
//@session_start();
	...
	$moxieManagerConfig['filesystem.exclude_file_pattern'] = '#low_#';
	$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,docx,doc,zip,pdf,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,mp4,mp3,swf';
	...
	$moxieManagerConfig['upload.max_width'] = 8000;
	$moxieManagerConfig['upload.max_height'] = 8000;
	...
	$moxieManagerConfig['thumbnail.width'] = 460;
	$moxieManagerConfig['thumbnail.height'] = 460;
	...
	// AutoFormat
	$moxieManagerConfig['autoformat.rules'] = '1240*1240=low_%f.%e';
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "seenkuser", "password" => "s33nkcms", "groups" => array("administrator"))
	);
