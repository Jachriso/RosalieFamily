...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        global $specialdir;
        $this->response = array();
        if(empty($this->specialdir))
            $this->specialdir = (isset($_SESSION['specialdir']) ? $_SESSION['specialdir'] : (isset($_GET['specialdir']) ? $_GET['specialdir'] : (isset($_POST['specialdir']) ? htmlentities($_POST['specialdir']) : '')));
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            'upload_dir' => dirname( __FILE__ ) . '/../../../../content/bdd/' . $this->specialdir . '/',
            'upload_url' => $_SERVER['DOMAIN_NAME'] . '/content/bdd/' . $this->specialdir . '/',
