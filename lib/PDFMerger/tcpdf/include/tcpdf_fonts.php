...
// ====================================================================================================================
	...
	public static function UTF8ArrayToUniArray($ta, $isunicode=true) {
		if ($isunicode) {
			return array_map(array('TCPDF_FONTSS', 'unichrUnicode'), $ta);
		}
		return array_map(array('TCPDF_FONTSS', 'unichrASCII'), $ta);
	}
	...
	public static function UTF8StringToArray($str, $isunicode=true, &$currentfont) {
		if ($isunicode) {
			...
			$carr = array_map(array('TCPDF_FONTSS', 'uniord'), $chars);
		} else {
			$chars = str_split($str);
