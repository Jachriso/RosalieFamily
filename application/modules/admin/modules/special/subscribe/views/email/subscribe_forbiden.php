...
<title><?php echo $starter->_get_lexique('Votre acc&egrave;s au &agrave; Rosalie family');?></title>
<style type="text/css">
body {
  width: 100%;
  margin: 0;
        ...
        <tbody>
          <tr>
            <td align="center"><img class="logo" style="width:65px;" src="{HTTP_ROOT}templates/default/content/static/logo.png" style="margin:0; padding:0; float:left">
                <h1 style="font-weight:bold;font-size:44px;color:#6c0149;display:inline-block;top:-15px;position: relative;"></h1></td>
          </tr>
        </tbody>
      </table></td>
  </tr>
  ...
  <tr>
      <td width="25" height="25"></td>
         ...
         <!-- TEXTE BOOK -->
          <tr>
      <td width="25"></td>
            <td editable="true" style="font-family:Verdana, Arial, sans-serif; color:#898989; font-size:22px; line-height:30px;text-align:center;font-weight: bold;"><?php echo $starter->_get_lexique('Votre acc&egrave;s &agrave; Rosalie family');?>.</td>
      <td width="25"></td>
          </tr>
          <!-- ESPACE -->
          <tr>
...
<?php echo $starter->_get_lexique('Apr&egrave;s traitement, nous vous informons que votre acc&egrave;s Rosalie family a &eacute;t&eacute; refus&eacute;.');?><br /><br />
