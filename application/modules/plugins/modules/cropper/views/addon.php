...
<script language="javascript" type="text/javascript">
	...
	parent.addButton('<?php echo $s_form_field;?>','<?php echo $s_filename ?>');
...
<body>
	...
	<div id="form_div">
        ...
        <h1> <?php echo $starter->_get_lexique('Rogner');?></h1>
...
<?php }?>
        ...
        <form name="upload_form" id="upload_form" action="?page=<?php echo $s_form_page;?>&module=<?php echo $s_module;?>&config_id=<?php echo $s_config;?>&lang=<?php echo $starter->s_lang;?>&ilang=<?php echo $starter->i_lang;?>&field=<?php echo $s_form_field;?>" method="post" enctype="multipart/form-data">
            ...
            <input autocomplete="off" type="hidden" id="action" name="action" value="upload"/>
...
<?php }?>
                ...
                <span class="info">
				    ...
				    <?php echo $starter->_get_lexique('extensions autorisées : ') . (isset($a_data['allowedFileExtensions']) ? $a_data['allowedFileExtensions'] : "jpeg,jpg,gif,png,zip");?><br />
                    
                </span>
                
                <span class="info">
				
				    <?php echo $starter->_get_lexique('dimensions minimum : ') . (isset($a_data['width']) && isset($a_data['height']) ? $a_data['width'] . " * " . $a_data['height'] : "100*100");?>
            ...
            <div class="small-button">
                ...
                <a onClick="document.getElementById('action').value='crop';document.forms['upload_form'].submit()" href="javascript:void(0);"><?php echo $starter->_get_lexique('Rogner');?></a>
