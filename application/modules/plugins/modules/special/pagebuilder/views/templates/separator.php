<!-- elemento separator -->
<div class="box box-element" data-type="separator" data-typename="Separator">
	<div class="actions">
	...
	<div class="preview">
		 <img class="svg" src="<?= $starter->MEDIA_PATH;?>interface/separator.svg" alt="">
		 <div class="element-desc">separator</div>
	</div>
	<div class="view">
