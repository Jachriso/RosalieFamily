        ...
        <div class="overview relative flex alignfC">
            <div class="inlineb">
                <div class="title margH20 padV5">
                    <span class="ft25 ftLH30"><?php echo $starter->_get_lexique("Tous les merci pour le business");?></span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-6 col-12">
                <div class="back1 pad20 relative">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <p class="ft40 ftblack ftLH46 alignR alignL-sm margT20 margT0-sm" ><?php echo count($stats->statistiques->a_data['mpbs']);?></p>
                        </div>
                        <div class="col-12">
                            <p class="ft40 ftblack ftLH46 alignR margT20 margT0-sm" ><?php echo $stats->statistiques->a_data['mpbs_amount']['total_amount'] . "€";?></p>
                        </div>
                        <div class="col-12">
                            <div class="listing">
<?php foreach($stats->statistiques->a_data['mpbs'] AS $key => $val){?>
                                <div class=" row g-3">
                                    <div class="col-12">
                                        <div class="">
                                            <?php echo $starter->_get_lexique("De") . " " . $val['sender_firstname'] . " " . $val['sender_lastname'] . " " . $val['sender_email'] . " " . $starter->_get_lexique("à") . " " . $val['receiver_firstname'] . " " . $val['receiver_lastname'] . " " . $val['receiver_email'] . " " . $starter->_get_lexique("le") . " " . $starter->utils->format_date("dd-mm-YYYY",$val['_create'], true, ' ') . " " . $val['mpb_amount'] ."€";?>
                                        </div>
                                    </div>
                                </div>
<?php 
