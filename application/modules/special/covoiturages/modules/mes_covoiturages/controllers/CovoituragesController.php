...
class Covoiturage extends Covoiturages
{
    ...
    private function init()
    {
		...
		if(!isset($_SESSION['user_info'])){
	    	...
	    	$this->a_data = $covoiturage->getCovoiturages($_SESSION['user_info']['user_id']);
			...
			$this->s_include_page = '/modules/special/covoiturages/views/' . (is_file(APPLICATION_PATH .'/modules/special/covoiturages/views/' . $starter->s_display. '/mes_covoiturages.php') ? $starter->s_display : 'default') . '/mes_covoiturages.php';

			// rel files
			$s_rel_id = $starter->mods['covoiturages']['modules']['mes_covoiturages']['rel'];
		}
    }
}
?>