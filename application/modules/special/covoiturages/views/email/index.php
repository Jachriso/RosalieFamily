...
<title><?php echo $starter->_get_lexique('Nouvelle réservation sur Rosalie Family.');?></title>
<style type="text/css">
body {
  width: 100%;
  margin: 0;
  ...
  <tr>
      <td width="25" height="25"></td>
         ...
         <!-- TEXTE BOOK -->
          <tr>
      <td width="25"></td>
            <td editable="true" style="font-family:Verdana, Arial, sans-serif; color:#898989; font-size:22px; line-height:30px;font-weight: bold;"><?php echo $starter->_get_lexique('Nouvelle réservation sur Rosalie Family');?></td>
      <td width="25"></td>
          </tr>
      ...
      <td width="25"></td>
        ...
        <?php echo $starter->_get_lexique('Nouvelle réservation sur Rosalie Family');?><br /></td>
      <td width="25"></td>
          </tr>          
          <!-- BOUTON PRIMAIRE-->
          <tr>
