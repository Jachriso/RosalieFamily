...
<title>🌟 <?php echo $starter->_get_lexique('Bonne nouvelle, le conducteur a confirm&eacute; l’accompagnement');?> 🚗✅</title>
<style type="text/css">
body {
  width: 100%;
  margin: 0;
...
<table width="100%" editable="true" mc:edit="text" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
      ...
      <td width="25"></td>
        ...
        <?php echo $starter->_get_lexique("Bonne nouvelle ! Le conducteur");?> {NAME} <?php echo $starter->_get_lexique("que tu as sollicité pour accompagner");?> {PRENOMCHILD} <?php echo $starter->_get_lexique("sur le trajet");?> {DESTINATION} <?php echo $starter->_get_lexique("a confirmé");?> ✅ <?php echo $starter->_get_lexique("qu'il est bien d'accord pour l'accompagner");?> 🚗👦👧.<br />
        <?php echo $starter->_get_lexique("Tu peux maintenant être tranquille et compter sur lui pour ce trajet.");?><br>
        <?php echo $starter->_get_lexique("Merci de faire confiance à Rosalie Family et de participer à cette belle communauté");?>  🌟,<br />
      </td>
      <td width="25"></td>
          </tr>          
          <!-- BOUTON PRIMAIRE-->
          <tr>
      <td width="25"></td>
            <td  style="font-family:Verdana, Arial, sans-serif; color:#898989; font-size:14px;text-align:right"><br /></td>
      <td width="25"></td>
          </tr>
          <tr>
      <td width="25"></td>
            ...
            <?php echo $starter->_get_lexique("&Agrave bient&ocirc;t,") ;?><br /><br />
<?php echo $starter->_get_lexique("L'&eacute;quipe Rosalie family") ;?> 🌸<br /></td>
      <td width="25"></td>
          </tr>
  <tr>
      <td width="25" height="25"></td>
