...
<title>🌟 <?php echo $starter->_get_lexique('Bonne nouvelle, un adh&eacute; a confirm&eacute; son accompagnement');?> 👍</title>
<style type="text/css">
body {
  width: 100%;
  margin: 0;
...
<table width="100%" editable="true" mc:edit="text" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
      ...
      <td width="25"></td>
        ...
        <?php echo $starter->_get_lexique("Bonne nouvelle !");?> {NAME} <?php echo $starter->_get_lexique(" à validé le trajet de");?> {PRENOMCHILD} <?php echo $starter->_get_lexique("pour aller à");?> {DESTINATION} 🚗👦👧.<br />
