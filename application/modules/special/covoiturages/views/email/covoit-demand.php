...
<title>🌟 <?php echo $starter->_get_lexique("Ton covoiturage est s&eacute;lectionn&eacute; ! Il ne te reste plus qu'&agrave; le valider");?></title>
<style type="text/css">
body {
  width: 100%;
  margin: 0;
...
<table width="100%" editable="true" mc:edit="text" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
      ...
      <td width="25"></td>
          ...
          <tr>
      <td width="25"></td>
            <td editable="true" style="font-family:Verdana, Arial, sans-serif; color:#898989; font-size:14px; line-height:22px;text-align:justify;"><br /><?php echo $starter->_get_lexique('Bonjour') ;?> {PRENOM},<br /><br />
        <?php echo $starter->_get_lexique('Bonne nouvelle : ton trajet pour');?> {PRENOMCHILD} <?php echo $starter->_get_lexique('le');?> {JOUR} <?php echo $starter->_get_lexique('&agrave; &eacute;t&eacute; s&eacute;lectionn&eacute;');?> <?php echo $starter->_get_lexique('par');?> {NAME} <?php echo $starter->_get_lexique("pour aller &agrave;");?> {DESTINATION}.<br />
        <?php echo $starter->_get_lexique("Il ne te reste plus qu'&agrave; valider sa demande");?><br /><br />
        <?php echo $starter->_get_lexique('Un immense merci pour ta confiance.');?>
      </td>
      <td width="25"></td>
          </tr>          
          <!-- BOUTON PRIMAIRE-->          
      ...
      <td width="25"></td>
            ...
            <?php echo $starter->_get_lexique("A tr&egrave;s vite sur la route du partage !") ;?><br /><br />
<?php echo $starter->_get_lexique("L'&eacute;quipe Rosalie family") ;?><br />
🌸 <?php echo $starter->_get_lexique("Ensemble, c'est vraiment plus simple !") ;?></td>
      <td width="25"></td>
          </tr>
  <tr>
      <td width="25" height="25"></td>
