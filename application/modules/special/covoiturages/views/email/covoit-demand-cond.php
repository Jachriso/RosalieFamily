...
<title>🌟 <?php echo $starter->_get_lexique("Ton covoiturage est s&eacute;lectionn&eacute; ! Il ne te reste plus qu'&agrave; le valder");?></title>
<style type="text/css">
body {
  width: 100%;
  margin: 0;
...
<table width="100%" editable="true" mc:edit="text" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
      ...
      <td width="25"></td>
        ...
        <?php echo $starter->_get_lexique('Bonne nouvelle!');?> {NAME} <?php echo $starter->_get_lexique('compte sur toi  pour accompagner');?> {PRENOMCHILD} <?php echo $starter->_get_lexique('&agrave;');?> {DESTINATION} <?php echo $starter->_get_lexique('le');?> {JOUR}.<br />
