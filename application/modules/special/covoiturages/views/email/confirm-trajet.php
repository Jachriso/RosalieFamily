...
<title>{PRENOMCHILD} <?php echo $starter->_get_lexique('est bien arriv&eacute;(e) &agrave; destination !');?></title>
<style type="text/css">
body {
  width: 100%;
  margin: 0;
...
<table width="100%" editable="true" mc:edit="text" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
      ...
      <td width="25"></td>
        ...
        {PRENOM} <?php echo $starter->_get_lexique("vient de confirmer que");?> {PRENOMCHILD} <?php echo $starter->_get_lexique("est bien arriv&eacute;(e) à");?> {DESTINATION} <?php echo $starter->_get_lexique(", comme pr&eacute;vu");?> 🤗<br /><br />
        <?php echo $starter->_get_lexique("Merci de ta confiance !");?> 🚗🌟<br /></td>  
      <td width="25"></td>
          </tr>          
          <!-- BOUTON PRIMAIRE-->
          <tr>
      ...
      <td width="25"></td>
            <td editable="true" style="font-family:Verdana, Arial, sans-serif; color:#898989; font-size:14px; line-height:22px;text-align:left;"><br />
              <?php echo $starter->_get_lexique("A bient&ocirc;t sur la route du partage !") ;?><br />
<?php echo $starter->_get_lexique("L'&eacute;quipe Rosalie family") ;?><br />
🌸 <?php echo $starter->_get_lexique("Ensemble, c’est vraiment plus simple !") ;?><br />
</td>
      <td width="25"></td>
          </tr>
  <tr>
  ...
  <tr>
    <td>
       <table align="center" bgcolor="#DDDDDD" border="0" cellpadding="0" cellspacing="0" class="container" height="30" style="padding:20px;" width="560">
        <tbody>
          <tr>
            <td  style="font-family:Verdana, Arial, sans-serif; color:#898989; font-size:14px;text-align:right"></td>
          </tr>
        </tbody>
      </table></td>
  </tr>
