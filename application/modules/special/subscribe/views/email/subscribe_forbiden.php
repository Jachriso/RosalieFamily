...
<title><?php echo $starter->_get_lexique("Votre acc&egrave;s");?></title>
<style type="text/css">
body {
  width: 100%;
  margin: 0;
  ...
  <tr>
      <td width="25" height="25"></td>
         ...
         <!-- TEXTE BOOK -->
          <tr>
      <td width="25"></td>
            <td editable="true" style="font-family:Verdana, Arial, sans-serif; color:#898989; font-size:22px; line-height:30px;text-align:center;font-weight: bold;"><?php echo $starter->_get_lexique("Votre acc&egrave;s");?>.</td>
      <td width="25"></td>
          </tr>
          <!-- ESPACE -->
          <tr>
...
<?php echo $starter->_get_lexique("Apr&egrave;s traitement, nous vous informons que votre acc&egrave;s a &eacute;t&eacute; refus&eacute;.");?><br /><br />
