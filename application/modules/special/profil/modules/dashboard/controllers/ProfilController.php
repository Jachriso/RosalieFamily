...
class Profil extends Profils
{
    ...
    private function init()
    {
		...
		$this->s_include_page = '/modules/special/profil/views/' . (is_file(APPLICATION_PATH .'/modules/special/profil/views/' . $starter->s_display. '/index.php') ? $starter->s_display : 'default') . '/index.php';
