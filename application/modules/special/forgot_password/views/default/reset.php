<div class="pad20">
    ...
    <div class="margT20">
        <div class="alignC">
            <h1 class="bolder"><?php echo $starter->_get_lexique('Renouvellement de votre mot de passe.');?></h1>
        </div>
        <div class="alignC">
...
<?php  if(!isset($_SESSION['WARNING'])){?>				
				<h3 class="" ><?php echo $starter->_get_lexique('Veuilez copier le mot de passe ci-dessous et le coller dans le formulaire disponible');?> <a target="_blank" href="<?php echo $starter->HTTP_ROOT;?>" class=""><?php echo $starter->_get_lexique('ici');?>.</a><br />
